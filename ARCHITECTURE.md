...
### 7.18 `pulse-crash` (KMP core + Android actual) — *powers the **Crashes** panel*
...
### 7.19 `pulse-provenance` (KMP · commonMain) — *powers the **Commit History** panel*
